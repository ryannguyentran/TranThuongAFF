...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-28',
    name: 'Móc khoá ô tô xe máy Logo VINFAST dây da',
    category: 'Xe Hơi - Ô tô',
    mainCategory: 'Xe Hơi - Ô tô',
    mainCategories: ['Xe Hơi - Ô tô', 'Xe Máy'],
    subCategory: '',
    image: '/images/mockhoa_vinfast.jpg',
    realImage: '/images/mockhoa_vinfast_thucte.jpg',
    realImages: ['/images/mockhoa_vinfast_thucte.jpg'],
    videoUrl: 'https://youtube.com/shorts/uPOPxx_jQro?feature=share',
    originalPrice: 0,
    salePrice: 0,
    badge: 'Deal hot',
    isMall: false,
    rating: 5.0,
    soldCount: '',
    affiliateUrl: 'https://s.shopee.vn/1gIgD8i5OX',
    voucherTag: '',
    description: 'Móc khoá ô tô xe máy Logo VinFast cao cấp dây da thời trang, sang trọng và bền đẹp.',
    note: 'Shop cho 4 con ốc, về phải tự vít vào, vít từ từ ko nó lờn nhé.Mình mua 20k',
  },
  {
    id: 'prod-29',
    name: 'Logo Dán móc khoá các hãng xe',
    category: 'Xe Hơi - Ô tô, Xe Máy',
    mainCategory: 'Xe Hơi - Ô tô',
    mainCategories: ['Xe Hơi - Ô tô', 'Xe Máy'],
    subCategory: '',
    image: '/images/logo_dan_mockhoa.jpg',
    realImage: '/images/logo_dan_mockhoa_thucte.jpg',
    realImages: ['/images/logo_dan_mockhoa_thucte.jpg'],
    videoUrl: 'https://youtube.com/shorts/uPOPxx_jQro?feature=share',
    originalPrice: 0,
    salePrice: 0,
    badge: 'Deal hot',
    ...
    rating: 5.0,
    soldCount: '',
    affiliateUrl: 'https://s.shopee.vn/2gBDP36m3T',
    voucherTag: '',
    description: 'Miếng logo dán móc khoá nhận diện các hãng xe ô tô, xe máy sắc nét, giá rẻ tiết kiệm.',
    note: 'Không được ngay giữa nhưng ok giá 15k thì cũng ổn',
  },
  {
    id: 'prod-30',
    name: 'Giá để cốc ô tô hai lỗ này có 2 khe đựng riêng biệt Giá rẻ',
    category: 'Xe Hơi - Ô tô › Minio Green - VF2',
    mainCategory: 'Xe Hơi - Ô tô',
    subCategory: 'Minio Green - VF2',
    image: '/images/giadecoc_2lo.jpg',
    realImage: '/images/giadecoc_2lo_thucte1.jpg',
    realImages: ['/images/giadecoc_2lo_thucte1.jpg', '/images/giadecoc_2lo_thucte2.jpg'],
    videoUrl: 'https://youtube.com/shorts/I_rYuO6swDk?feature=share',
    originalPrice: 0,
    salePrice: 0,
    badge: 'Deal hot',
    isMall: false,
    rating: 5.0,
    soldCount: '',
    affiliateUrl: 'https://s.shopee.vn/AKaeYAIXyc',
    voucherTag: '',
    description: 'Giá để cốc ô tô 2 lỗ có khe đựng riêng biệt, phía sau có nút tăng đưa điều chỉnh to nhỏ chắc chắn.',
    note: 'Bộ này ko đến 200k mà chắc chắn vì phía sau có tăng đưa to nhỏ',
  },
  {
    id: 'prod-31',
    name: 'Tấm Chắn Gió Điều Hoà Ô tô',
    category: 'Xe Hơi - Ô tô › Minio Green - VF2',
    mainCategory: 'Xe Hơi - Ô tô',
    subCategory: 'Minio Green - VF2',
    image: '/images/tamchangio_dieuhoa.jpg',
    realImage: '/images/tamchangio_dieuhoa_thucte1.jpg',
    realImages: ['/images/tamchangio_dieuhoa_thucte1.jpg', '/images/tamchangio_dieuhoa_thucte2.jpg'],
    videoUrl: 'https://youtube.com/shorts/Bza-QRfjMNk',
    originalPrice: 0,
    salePrice: 0,
    badge: 'Deal hot',
    isMall: false,
    rating: 5.0,
    soldCount: '',
    affiliateUrl: 'https://s.shopee.vn/9AOibTHki0',
    voucherTag: '',
    description: 'Tấm chắn gió điều hoà ô tô giúp định hướng luồng gió, tránh phả thẳng vào mặt, khe gió ngang tỏa mát đều khoang xe.',
    note: 'Do Minio -VF2 điều hoà điều chỉnh được quá ít khóc, cứ phà thẳng vào đi đưởng rất lạnh. Mình mua thử cái này xem sao thì dùng rất ok nhé, áp mã vào chưa dến 90k . Nó có khe gió theo chiều ngang, lên cả dưới chân cũng mát. Vừa khít với cổng điều hoà của xe. Anh em xem Clip và Ảnh mình post kèm nhé. AH MINIO CHỌN PHONG CÁCH 8 NHA',
  },
];
